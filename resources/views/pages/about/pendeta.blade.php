...
<h1 class="font-h1 text-h1 text-primary mb-1">Pdt. Dr. Yerusa Maria Agustini, S.Si., M.Pd.</h1>
<p class="font-h3 text-h3 text-gray-600">Pendeta Jemaat GKI Komplek Pakuwon</p>
...
<p class="text-gray-600 mt-1">Langkah awal dalam pengabdian struktural jemaat.</p>
</div>
<div class="relative pl-12">
<div class="absolute left-2.5 top-1.5 w-3 h-3 bg-secondary rounded-full border-2 border-white ring-4 ring-secondary/20"></div>
...
<p class="text-gray-600 mt-1">Memasuki masa kependetaan penuh melalui penahbisan resmi.</p>
</div>
<div class="relative pl-12">
<div class="absolute left-2.5 top-1.5 w-3 h-3 bg-secondary rounded-full border-2 border-white ring-4 ring-secondary/20"></div>
...
<p class="text-gray-600 mt-1">Pengukuhan komitmen pelayanan berkelanjutan dalam gereja.</p>
</div>
<div class="relative pl-12">
...
<h3 class="font-h3 text-h3 text-primary font-bold">Melayani di GKI Komplek Pakuwon</h3>
<p class="text-gray-600 mt-1">Memberikan bimbingan spiritual dan kepemimpinan bagi jemaat Pakuwon.</p>
</div>
</div>
</div>
</div>
...
<h3 class="font-label-md text-primary">S1 Teologi</h3>
<p class="text-gray-600 leading-relaxed">Universitas Kristen Dutawacana Yogyakarta</p>
</div>
<div class="flex flex-col gap-1">
<span class="font-label-sm text-secondary px-2 py-0.5 bg-secondary/10 rounded-md self-start">2010 - 2012</span>
<h3 class="font-label-md text-primary">S2 Manajemen / Administrasi Pendidikan</h3>
<p class="text-gray-600 leading-relaxed">Universitas Kristen Indonesia</p>
</div>
<div class="flex flex-col gap-1">
<span class="font-label-sm text-secondary px-2 py-0.5 bg-secondary/10 rounded-md self-start">2016 - 2020</span>
<h3 class="font-label-md text-primary">S3 Teknologi Pendidikan Konsentrasi PAUD</h3>
<p class="text-gray-600 leading-relaxed">Universitas Negeri Jakarta</p>
</div>
</div>
</div>
...
<span class="font-label-md text-primary">Selasa &amp; Kamis, 10:00 - 14:00</span>
</div>
</div>
</div>
</aside>
