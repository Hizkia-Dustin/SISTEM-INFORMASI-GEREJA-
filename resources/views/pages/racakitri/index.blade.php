<x-layout title="Raca Kitri" :fullWidth="true">
    <div class="max-w-[1440px] mx-auto px-8 py-12 md:py-16">
        ...
        @php
            ...
            $dummyArticles = [
                (object)[
                    'title' => 'Raca Kitri Edisi Paskah 2024',
                ...
                (object)[
                    'title' => 'Raca Kitri Edisi Awal Tahun 2024',
                ...
                (object)[
                    'title' => 'Raca Kitri Edisi Natal 2023',
        ...
        @if($hasArticles && count($dummyArticles) > 0)
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                ...
                @foreach($dummyArticles as $article)
                    <x-article-card 
                        :article="$article" 
                        url="{{ route('racakitri.show', $article->slug) }}"
        ...
        @else
            ...
            <!-- ========================================== -->
            <x-empty-state title="Sedang Menyiapkan Edisi">
