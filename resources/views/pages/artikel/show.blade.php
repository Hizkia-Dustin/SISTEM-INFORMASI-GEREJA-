<x-layout title="Baca Artikel" :fullWidth="true">
    <div class="max-w-[1440px] mx-auto px-8 py-12 md:py-16">
        ...
        <div class="mb-8 flex items-center justify-between gap-4 flex-wrap">
            <a href="{{ route('artikel.index') }}" class="inline-flex items-center gap-2 font-label-md text-on-surface-variant hover:text-secondary transition-colors group">
        ...
        <div class="max-w-4xl mx-auto mt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <a href="{{ route('artikel.index') }}" class="px-6 py-2.5 bg-primary-container text-white rounded-full font-label-md hover:bg-primary transition-colors shadow-sm text-center w-full sm:w-auto">
