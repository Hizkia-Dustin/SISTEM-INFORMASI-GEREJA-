<x-layout title="Warta Jemaat" :fullWidth="true">
    <div class="max-w-[1440px] mx-auto px-8 py-12 md:py-16">
        ...
        @php
            ...
            $dummyArticles = [
                (object)[
                    'title' => 'Warta Jemaat - 12 Mei 2024',
                ...
                (object)[
                    'title' => 'Warta Jemaat - 28 April 2024',
        ...
        @else
            ...
            <!-- ========================================== -->
            <x-empty-state title="Menyiapkan Warta Terkini">
