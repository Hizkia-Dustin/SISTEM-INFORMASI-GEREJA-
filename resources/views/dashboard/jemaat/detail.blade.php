            ...
            <div class="grid grid-cols-2 gap-10">
                <div class="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <a href="{{ asset('storage/' . $jemaat->lampiran_baptis) }}" target="_blank" rel="noopener" class="text-xs font-bold text-primary hover:underline flex items-center gap-1">
                ...
                <div class="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <a href="{{ asset('storage/' . $jemaat->lampiran_sidi) }}" target="_blank" rel="noopener" class="text-xs font-bold text-primary hover:underline flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13"></path></svg>
                            Lihat Lampiran Sidi
                        </a>
                    </div>
