...
<div class="flex items-center justify-between mb-10">
    ...
    <div class="flex gap-3">
        <a href="{{ url('/') }}" class="px-5 py-2.5 bg-primary text-white rounded-xl text-sm font-bold shadow-lg shadow-primary/20 hover:bg-blue-600 transition-all flex items-center gap-2">
